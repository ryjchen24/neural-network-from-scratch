...
- Training and testing loops built into functions
- Interpretable evaluation and visualization including matplotlib graphs, a confusion matrix and image visualization

The goal is to deeply understand how modern neural networks truly work by practicing building all the steps that are required for one to run
...
- Matplotlib
- Sklearn
- PyTorch (To compare our neural network model to PyTorch)
...
- Confusion Matrix
- Image visualization with predicted vs. true values
...
```bash
git clone https://github.com/ryjchen24/neural-network-from-scratch.git
